...
{
    public static IServiceCollection AdicionarAutenticacaoJwtLancamentos(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddAuthorizationBuilder()
            .AddPolicy(PoliticasAutorizacao.LancamentosEscrita, builder => builder.ExigirEscopo(PoliticasAutorizacao.LancamentosEscrita))
            .AddPolicy(PoliticasAutorizacao.LancamentosLeitura, builder => builder.ExigirEscopo(PoliticasAutorizacao.LancamentosLeitura));
